...
class Main {
	...
	public static void customCode() {
		...
		System.out.println(true==parser.isInLanguage(cfg, new Word("1+0")));
    System.out.println(false==parser.isInLanguage(cfg, new Word("01")));
    System.out.println(false==parser.isInLanguage(cfg, new Word("*-*")));
    System.out.println(true==parser.isInLanguage(cfg, new Word("1*-0*-1+0*-1")));
    System.out.println(true==parser.isInLanguage(cfg, new Word("0+-1*-0+1*1")));
    System.out.println(false==parser.isInLanguage(cfg, new Word("1*0+--1+0*1")));
    System.out.println(false==parser.isInLanguage(cfg, new Word("1*0+0-1+1*0+-0")));

    parser.generateParseTree(cfg, new Word("1+0")).print();
    parser.generateParseTree(cfg, new Word("01")).print();
    parser.generateParseTree(cfg, new Word("*-*")).print();
    parser.generateParseTree(cfg, new Word("1+x")).print();
    System.out.println(parser.isInLanguage(cfg, new Word("1+-1")));
    parser.generateParseTree(cfg, new Word("1+-1")).print();
    System.out.println(parser.isInLanguage(cfg, new Word("1+1*1")));
    parser.generateParseTree(cfg, new Word("1+1*1")).print();
    System.out.println(parser.isInLanguage(cfg, new Word("1+1*1")));
    parser.generateParseTree(cfg, new Word("1+1*1")).print();
	}
